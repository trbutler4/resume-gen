...
- Led the overhaul of UI development practices to a *design system-based approach*, unifying brand identity across products while mentoring junior developers and designers.
...
- Worked across the entire stack, implementing critical systems including websocket and AWS secure enclave.
...
- Co-Founder of ETHChicago, a Midwest Ethereum and Web3 community.
...
- Built Web3 and smart contract applications for clients.
